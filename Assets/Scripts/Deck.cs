...
public class Deck <T> where T : Card
{
    ...
    private int GetIndexFromPosition(DeckPosition position)
    {
        ...
        //get end index if its on "from the top"
    ...
    public void Add(T card, DeckPosition position = DeckPosition.Top)
    {
        ...
        // to add it to Top we actually want to add at the end,
    ...
    /// <summary>
    /// randomly shuffle cards,  from the bottom up 
    /// </summary>
    public void Shuffle()
    {
        ...
        {
            //chose a random card, but not ones we have already placed
